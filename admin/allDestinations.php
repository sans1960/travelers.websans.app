...
<nav class="flex flex-col justify-center p-4 text-white bg-green-700 md:flex-row md:justify-around">
    ...
    <a href="" class="p-2 text-white bg-green-600 rounded-full">
    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <table class="mx-auto mt-2 mb-5 table-auto" id="one">
        <thead>
        <tr class="p-2">
                        <th class="p-2">ID</th>
        ...
        <?php require '../config/db.php'; ?>
                        <?php require '../models/Destination.php'; ?>
                            ...
                            <tr class="p-2 text-center">
                                <td class="p-2"><?php echo $dest['id'];?></td>
                                <td class="p-2"><?php echo $dest['name'];?></td>
