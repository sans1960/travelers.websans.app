...
<div class="container flex justify-end w-3/4 mt-5">
    <a href="addCountry.php" class="p-2 text-white bg-green-600 rounded-full">
    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
 ...
 <div class="container w-3/4 mx-auto mt-5 mb-5">
    <table class="mx-auto mt-2 mb-5 table-auto" id="two">
        <thead>
        <tr class="p-2">
                        <th class="p-2">ID</th>
        ...
        <?php require '../config/db.php'; ?>
                        <?php require '../models/Country.php'; ?>
							<?php 
							$countries = new Country();
							$counts = $countries->get_allcountries();
							foreach ($counts as $count) {?>
                            <tr class="p-2 text-center">
                                <td class="p-2"><?php echo $count['id'];?></td>
                                <td class="p-2"><?php echo $count['name'];?></td>
                                <td class="p-2"><?php echo $count['dest'];?></td>
